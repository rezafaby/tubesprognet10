        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Prefix Antrean</label>
                    <input class="form-control" id="prefix_antrean" name="prefix_antrean" rows="3" value = "{{ $data->prefix_antrean }}" required></input>
                  </div>
                  <div class="nk-fmg-actions">
                    <div class="btn-group">
