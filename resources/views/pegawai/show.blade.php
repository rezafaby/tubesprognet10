        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input class="form-control" id="group" name="gkomponen_detail"  value="{{ $data->Pegawai->nama }}" disabled readonly>
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Kode</label>
                    <input class="form-control" id="group" name="gkomponen_detail"  value="{{ $data->Pegawai->kode }}" disabled readonly>
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                    <input class="form-control" id="group" name="gkomponen_detail"  value="{{ $data->Pegawai->alamat }}" disabled readonly>
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Tanggal Lahir</label>
                    <input class="form-control" id="group" name="gkomponen_detail"  value="{{ $data->Pegawai->tanggal_lahir }}" disabled readonly>
                  </div>
            </div>
        </div>
    </div>
