...
<!-- <div class="nk-fmg-body-content"> -->
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                <form id="form" action="{{route('komponengroups.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Group</label>
                    <input class="form-control" id="group" name="group" placeholder="Masukkan Group" required>
                  </div>
                  <div class="nk-fmg-actions">
                    <div class="btn-group">
